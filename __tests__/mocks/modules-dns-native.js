...
const nativeDNS = {
  ...
  async queryTXT(_domain, _message, _port, _deadlineEpochMs) {
    return ["mock"];
  },
  async queryTXTUDP(_domain, _message, _port, _deadlineEpochMs) {
    return ["mock"];
  },
  async queryTXTTCP(_domain, _message, _port, _deadlineEpochMs) {
    return ["mock"];
  },
