...
4. Add release notes:
   ...
   • Fixed chat detail navigation chrome in light and dark mode
   • Improved chat scrolling while typing so the latest message stays visible
   • Hardened app-opened external links with a shared allowlist
   ```
