# DNS Chat v3.0.2 - App Store Materials (VERIFIED AGAINST CODE)
...
DNS Chat v3.0 showcases a complete redesign following Apple's latest iOS 26 Liquid Glass Human Interface Guidelines:
...
- Refined glass card appearance (v3.0.2: removed gray overlays)
