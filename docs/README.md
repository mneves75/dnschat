...
- `docs/EXECPLAN-2026-01-04-EXPO-ROUTER-MIGRATION.md` (Expo Router migration plan + execution record)
...
- `docs/EXECPLAN-2026-01-05-GUIDELINES-REVERIFY.md` (guidelines re-verification + best-practice alignment refresh, latest)
