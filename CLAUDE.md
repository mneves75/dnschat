...
- Current `main` (2026-08-05): `4.3.4`, build `82`. Working version, not a TestFlight release - see the `[4.3.4]` changelog entry (device-only encryption key, brace-expansion floor, Expo/RN pod alignment, chat send-button solid fill).
