    ...
    ? [
        {
          ...
          messages: [
            ...
            },
            {
              id: "msg-2",
              content:
                "O DNSChat criptografa o histórico local no dispositivo. As consultas DNS continuam observáveis, então não envie segredos ou dados pessoais.",
            ...
            },
            {
              id: "msg-4",
              content:
                "Não. O transporte DNS pode ser observado por resolvedores e redes. Use o app para prompts curtos e não sensíveis.",
              role: "assistant" as const,
        ...
        },
        {
          ...
          messages: [
            ...
            },
            {
              id: "msg-6",
              content:
                "Queries DNS são extremamente rápidas, geralmente respondendo em 100-500ms. O DNS Chat usa métodos nativos otimizados para iOS e Android.",
              role: "assistant" as const,
    ...
    : [
        {
          ...
          messages: [
            ...
            },
            {
              id: "msg-2",
              content:
                "DNSChat encrypts local history on device. DNS queries remain observable, so do not send secrets or personal data.",
              role: "assistant" as const,
              timestamp: new Date(now - 3400000),
              status: "sent" as const,
            },
            ...
            },
            {
              id: "msg-4",
              content:
                "No. DNS transport can be observed by resolvers and networks. Use the app for short, non-sensitive prompts.",
              role: "assistant" as const,
              timestamp: new Date(now - 3200000),
              status: "sent" as const,
            },
        ...
        },
        {
          ...
          messages: [
            ...
            },
            {
              id: "msg-6",
              content:
                "DNS queries are extremely fast, typically responding in 100-500ms. DNS Chat uses optimized native methods for iOS and Android.",
              role: "assistant" as const,
              timestamp: new Date(now - 7000000),
              status: "sent" as const,
            },
      ...
      entries: [
        {
          ...
          message: isPortuguese
            ? "Iniciando query nativa iOS"
            : "Starting native iOS query",
          duration: 450,
        },
        {
          id: "entry-2",
      ...
      entries: [
        {
          ...
          method: "native",
          message: isPortuguese
            ? "Tentando query nativa"
            : "Attempting native query",
          duration: 100,
        },
        {
          id: "entry-4",
          ...
          method: "native",
          message: isPortuguese
            ? "Timeout nativo, alternando para UDP"
            : "Native timeout, falling back to UDP",
        },
        {
          id: "entry-5",
          ...
          method: "udp",
          message: isPortuguese
            ? "Query UDP bem-sucedida"
            : "UDP query successful",
          duration: 200,
        },
      ],
    },
      ...
      entries: [
        {
          ...
          method: "native",
          message: isPortuguese
            ? "Query nativa bem-sucedida"
            : "Native query successful",
          duration: 150,
        },
      ],
    },
