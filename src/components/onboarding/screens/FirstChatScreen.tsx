          ...
          {!hasTriedChat && (
            <View style={styles.suggestionsContainer}>
              <Text style={[
                ...
                isDark ? styles.darkSuggestionsTitle : styles.lightSuggestionsTitle
              ]}>
                Try one of these:
              </Text>
              {suggestedMessages.map((suggestion, index) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    isDark ? styles.darkSuggestionButton : styles.lightSuggestionButton
                  ]}
                  onPress={() => setInputText(suggestion)}
                >
                  <Text style={[
                    styles.suggestionText,
                    isDark ? styles.darkSuggestionText : styles.lightSuggestionText
                  ]}>
                    {suggestion}
                  </Text>
                </TouchableOpacity>
  ...
  return (
    <View style={[
      ...
      <View style={[
        ...
        message.isUser 
          ? (isDark ? styles.darkUserBubble : styles.lightUserBubble)
          : (isDark ? styles.darkAssistantBubble : styles.lightAssistantBubble)
      ]}>
        <Text style={[
          styles.messageText,
          message.isUser
            ? styles.userMessageText
            : (isDark ? styles.darkAssistantMessageText : styles.lightAssistantMessageText)
        ]}>
          {message.text}
        </Text>
