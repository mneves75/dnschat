...
export function FeaturesScreen() {
  ...
  const features: Feature[] = [
    ...
    },
    {
      ...
      description: 'Beautiful interface that adapts to your system preferences automatically.',
    },
    {
      icon: '💾',
      title: 'Local Storage',
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={[
          ...
          <Text style={[
            ...
            You now know how to use DNS Chat and have optimized settings for your network. 
            Start chatting and experience the magic of DNS-powered conversations!
          </Text>
        </View>
      </ScrollView>
      ...
      {feature.action && (
        ...
        >
          <Text style={[
            ...
            isDark ? styles.darkFeatureActionText : styles.lightFeatureActionText
          ]}>
            {feature.action.text}
          </Text>
        </TouchableOpacity>
