...
export const LiquidGlassButton: React.FC<LiquidGlassButtonProps> = ({
  ...
  const glassStyle =
    variant === "ghost" ? "systemThinMaterial" : "systemMaterial";
...
export const LiquidGlassChatBubble: React.FC<LiquidGlassChatBubbleProps> = ({
  ...
  const slideAnim = useRef(
    new Animated.Value(animateOnAppear ? 20 : 0),
  ).current;
          ...
          containerStyle={[
            ...
            type === "system" && styles.systemBubble,
            {
              backgroundColor: isPressed
                ? `${bubbleConfig.tintColor}60`
                : bubbleConfig.tintColor,
            },
          ]}
        >
          <View style={styles.bubbleContent}>
            ...
            {status === "sending" && (
              <View style={styles.statusIndicator}>
                <Text
                  style={[styles.statusText, { color: bubbleConfig.textColor }]}
                >
                  Sending...
                </Text>
              </View>
...
export const LiquidGlassContainer: React.FC<LiquidGlassContainerProps> = ({
  ...
  return (
    <LiquidGlassView
      ...
      sensorAware={capabilities?.features.sensorAware}
      environmentalAdaptation={capabilities?.features.environmentalCues}
      containerStyle={[styles.glassContainer, containerLayout, containerStyle]}
      {...glassProps}
    >
      {children}
    </LiquidGlassView>
