...
function ErrorFallback({ error, onRetry }: ErrorFallbackProps) {
  ...
  return (
    <View style={[styles.container, isDark ? styles.darkContainer : styles.lightContainer]}>
      ...
      <Text style={[styles.message, isDark ? styles.darkMessage : styles.lightMessage]}>
      ...
      <TouchableOpacity
        ...
        onPress={onRetry}
      >
        <Text style={[styles.retryButtonText, isDark ? styles.darkRetryButtonText : styles.lightRetryButtonText]}>
          Try Again
        </Text>
      </TouchableOpacity>
    </View>
