...
export const TutorialSafetyScene = () => {
  ...
  const facts = [
    ...
    [
      "DNS sem autenticação",
      "A rede pode observar ou alterar consultas e respostas.",
    ],
  ] as const;
          ...
          {facts.map(([title, detail], index) => (
            <div
              ...
              style={{
                ...
                backgroundColor:
                  index === 2 ? "rgba(255,142,142,0.1)" : "rgba(13,26,43,0.76)",
                opacity: interpolate(
                  frame,
            ...
            >
              ...
              <div
                style={{ fontSize: 27, lineHeight: 1.35, color: COLORS.muted }}
              >
                {detail}
              </div>
            </div>
